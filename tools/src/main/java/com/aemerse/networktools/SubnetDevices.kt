...
import com.aemerse.networktools.ARPInfo.allIPAddressesInARPCache
import com.aemerse.networktools.ARPInfo.allIPAndMACAddressesInARPCache
import com.aemerse.networktools.ARPInfo.allIPandMACAddressesFromIPSleigh
...
private constructor() {
    ...
    companion object {
        ...
        fun fromLocalAddress(): SubnetDevices {
            val ipv4 = IPTools.localIPv4Address
